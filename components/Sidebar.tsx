...
import { LayoutDashboard, Bot, ShoppingBag, TrendingUp, Map, Database, PieChart, Settings, Layers, ChevronDown, Check, LogOut, Calculator, UserCheck, FileStack } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    const modules = [
        ...
        { id: 'PAPERWORK', label: 'PAPERWORK', icon: FileStack },
                        ...
                        return (
                            <li key={mod.id}>
                                <button
                                    ...
                                    className={`w-full flex items-center gap-4 px-4 py-4 rounded-xl text-lg font-bold transition-all duration-200 group ${activeModule === mod.id
