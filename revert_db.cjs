...
async function main() {
    try {
        ...
        creds.phoneNumber = '+19302007070'; // Revert the phone number

        console.log("Saving reverted Twilio credentials to database...");
        ...
        console.log("✅ Successfully updated database system_settings to use +19302007070");
    } catch (e) {
