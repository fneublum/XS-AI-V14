      ...
      <div className="flex justify-between items-center border-b border-slate-200 pb-4">
        <div>
           <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
               <Calculator className="text-amber-600" /> DDP COST - IMPORTED GOODS
           </h2>
           <p className="text-slate-500 text-sm">{isHistoryMode ? 'Saved Calculations' : 'Calculate Landed Cost (DDP)'}</p>
        </div>
        {isHistoryMode ? (
            <button 
            ...
            <button onClick={resetForm} className="text-slate-500 hover:text-blue-600 flex items-center gap-1 text-sm">
