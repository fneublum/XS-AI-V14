        ...
        <div className="space-y-6">
            <div className="mb-6 flex items-start justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-800">Document Viewer</h1>
                        <p className="text-slate-500 text-sm mt-1">Centralized repository of all scanned and extracted documents.</p>
                    </div>
                </div>
            </div>
