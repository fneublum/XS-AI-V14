...
const SupplierOffers: React.FC<SupplierOffersProps> = ({ offers, onAdd, onUpdate, onDelete, suppliers, products, onAddProduct, onAddSupplier, ports, onAddPort, locations, onAddLocation, dbError, currentCompanyId, availableCompanies }) => {
            ...
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
                        <Tag className="text-teal-600" /> Supplier Quotes
                    </h2>
                    <p className="text-slate-500 text-sm">Log and track incoming estimates from suppliers.</p>
                </div>
                <div className="flex gap-2">
                    ...
                    <button onClick={handleAddNew} className="p-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition-colors shadow-sm" title="Add Offer">
                        <FilePlus size={20} />
                    </button>
                </div>
            </div>
