...
import { Customer, Supplier, Port, Quote, SupplierQuote, SupplierOffer, User, Company, Opportunity, Shipment, PurchaseOrder, Product, InventoryItem, InventoryLog, SalesOrder, CargoAgent, FreightQuote, Booking, BillOfLading } from '../types';
import { getDashboardAgentResponse } from '../services/geminiService';
...
interface DashboardProps {
    ...
    ports: Port[];
    salesQuotes: Quote[];
    supplierQuoteRequests: SupplierQuote[];
    ...
    // Action Handlers for Active Mode
    onCreateSupplier?: (data: Partial<Supplier>) => Promise<void>;
    onCreateCustomer?: (data: Partial<Customer>) => Promise<void>;
    onCreateCargoAgent?: (data: Partial<CargoAgent>) => Promise<void>;
    onCreateFreightQuote?: (data: Partial<FreightQuote>) => Promise<void>;
    onCreatePurchaseOrder?: (data: Partial<PurchaseOrder>) => Promise<void>;
    onCreateSalesOrder?: (data: Partial<SalesOrder>) => Promise<void>;
    onRequestBooking?: (data: Partial<Booking>) => Promise<void>;
    // Update Handlers
    onUpdateCustomer?: (data: Customer) => Promise<void>;
    onUpdateSupplier?: (data: Supplier) => Promise<void>;
}
            ...
            <div className="flex-1 min-h-0 overflow-hidden">
                <ErrorBoundary>
                    <AiDashboard
                        ...
                        onCreateCargoAgent={onCreateCargoAgent}
                        onCreateFreightQuote={onCreateFreightQuote}
