...
const buildColumns = (
  ...
  { id: 'inv', header: 'Invoice', mono: true, sortable: true, filterable: true, width: '85px',
  ...
  { id: 'amount', header: 'Amount', align: 'right', headerAlign: 'center', mono: true, sortable: true, width: '36px',
